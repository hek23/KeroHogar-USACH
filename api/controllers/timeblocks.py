...
def getAvailableTimeBlocks(date):
    query = "SELECT otb.time_block_id, COUNT(*)FROM orders o INNER JOIN order_time_block otb on o.id=otb.order_id INNER JOIN time_blocks tb on tb.id=otb.time_block_id where o.delivery_date = \'{}\' AND o.delivery_status=1 GROUP BY o.delivery_date, otb.time_block_id;"
